...
"""
Script to build opentracing-cpp for RACE
"""
...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("opentracing-cpp", "1.6.0", 1, __file__)
...
if __name__ == "__main__":
    ...
    builder.fetch_source(
        args=args,
        source=f"https://github.com/opentracing/opentracing-cpp/archive/refs/tags/v{args.version}.tar.gz",
        extract="tar.gz",
    )

    source_dir = os.path.join(args.source_dir, f"opentracing-cpp-{args.version}")
